...
| 任务 | 说明 | 预计工时 | 状态 |
|------|------|----------|------|
| 6.1 添加废弃警告 | 旧引擎 API 标记废弃 | 4h | ✅ 已完成 |
| 6.2 迁移文档 | 编写迁移指南 | 8h | ✅ 已完成 |
| 6.3 集成 unified_engine | review.py 使用统一引擎 | 8h | ✅ 已完成 |
| 6.4 移除旧引擎 | ast_engine 转为内部模块 | 4h | ✅ 已完成 |
| 6.5 清理环境变量 | USE_AST_ENGINE 已废弃 | 2h | ✅ 已完成 |
